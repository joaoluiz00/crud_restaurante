...
async function gerarRelatorio() {
    try {
        const dataInicial = prompt("Data inicial (YYYY-MM-DD): ");
        const dataFinal = prompt("Data final (YYYY-MM-DD): ");

        // Ajusta a data final para 23:59:59
        const dataFinalAjustada = `${dataFinal} 23:59:59`;
